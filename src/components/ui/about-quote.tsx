        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Данное исследование посвящено изучению того, как самооценка и тип мышления учащихся 5–9 классов влияют на их академическую успеваемость. Мы предполагаем, что эти психологические факторы тесно взаимосвязаны и оказывают значимое воздействие на учебные результаты.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Результаты помогут педагогам, школьным психологам и родителям выстроить более эффективную поддержку подростков — понимая, что за оценками стоят внутренние убеждения ребёнка о себе и своих возможностях.
            </p>
          </div>
        </div>
      </div>
